@testset "Events/Document Type Declaration" begin
    ...
    @testset "Events/Document Type Declaration (Positive)" begin
        ...
        #
        @test (collect(E.events(L.State(IOBuffer("<!DOCTYPE a>")))) == [ E.DTDStart("a", nothing, L.Location("a buffer", -1)),
                                                                         E.DTDEnd(L.Location("a buffer", -1)) ])
        @test (collect(E.events(L.State(IOBuffer("<!DOCTYPE abc>")))) == [ E.DTDStart("abc", nothing, L.Location("a buffer", -1)),
                                                                           E.DTDEnd(L.Location("a buffer", -1)) ])
        @test (collect(E.events(L.State(IOBuffer("<!DOCTYPE é>")))) == [ E.DTDStart("é", nothing, L.Location("a buffer", -1)),
                                                                         E.DTDEnd(L.Location("a buffer", -1)) ])
        @test (collect(E.events(L.State(IOBuffer("<!DOCTYPE aé>")))) == [ E.DTDStart("aé", nothing, L.Location("a buffer", -1)),
                                                                          E.DTDEnd(L.Location("a buffer", -1)) ])
        @test (collect(E.events(L.State(IOBuffer("<!DOCTYPE éb>")))) == [ E.DTDStart("éb", nothing, L.Location("a buffer", -1)),
                                                                          E.DTDEnd(L.Location("a buffer", -1)) ])
        @test (collect(E.events(L.State(IOBuffer("<!DOCTYPE aéb>")))) == [ E.DTDStart("aéb", nothing, L.Location("a buffer", -1)),
                                                                           E.DTDEnd(L.Location("a buffer", -1)) ])
