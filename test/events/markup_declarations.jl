@testset "Events/Markup Declarations" begin
    ...
    @testset "Events/Markup Declarations (Negative ... placeholders until parsers get written)" begin
        ...
        @test (events[1:2] == [ ME("ERROR: Expecting the start of a markup declaration.",
    ...
    @testset "Events/Markup Declarations (Negative ... invalid token after <!)" begin
        ...
        @test (events[1] == ME("ERROR: Expecting the start of a markup declaration.",
                               [ L.Token(L.mdo, "<!", L.Location("a buffer", -1)) ], L.Location("a buffer", -1)))
        ...
        @test (events[1:3] == [ ME("ERROR: The keyword 'attlist' must be uppercased.", [ ], L.Location("a buffer", -1)),
        ...
        @test length(events) >= 3
        @test (events[1:3] == [ ME("ERROR: The keyword 'doctype' must be uppercased.", [ ], L.Location("a buffer", -1)),
        ...
        events = evaluate("<!element")
        @test length(events) >= 3
        @test (events[1:3] == [ ME("ERROR: The keyword 'element' must be uppercased.", [ ], L.Location("a buffer", -1)),
                                ME("ERROR: Expecting the start of a markup declaration.",
                                   [ L.Token(L.mdo, "<!", L.Location("a buffer", -1)) ], L.Location("a buffer", -1)),
                                DC("element", false, L.Location("a buffer", -1)) ])
        ...
        @test length(events) >= 3
        @test (events[1:3] == [ ME("ERROR: The keyword 'entity' must be uppercased.", [ ], L.Location("a buffer", -1)),
        ...
        @test length(events) >= 3
        @test (events[1:3] == [ ME("ERROR: The keyword 'notation' must be uppercased.", [ ], L.Location("a buffer", -1)),
                                ME("ERROR: Expecting the start of a markup declaration.",
                                   [ L.Token(L.mdo, "<!", L.Location("a buffer", -1)) ], L.Location("a buffer", -1)),
        ...
        @test length(events) >= 3
        @test (events[1:3] == [ ME("ERROR: The keyword 'shortref' is not available in XML.", [ ], L.Location("a buffer", -1)),
                                ME("ERROR: Expecting the start of a markup declaration.",
                                   [ L.Token(L.mdo, "<!", L.Location("a buffer", -1)) ], L.Location("a buffer", -1)),
        ...
        @test length(events) >= 3
        @test (events[1:3] == [ ME("ERROR: The keyword 'usemap' is not available in XML.", [ ], L.Location("a buffer", -1)),
                                ME("ERROR: Expecting the start of a markup declaration.",
                                   [ L.Token(L.mdo, "<!", L.Location("a buffer", -1)) ], L.Location("a buffer", -1)),
